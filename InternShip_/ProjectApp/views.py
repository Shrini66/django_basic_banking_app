...
def customers(request):
    ...
    return render(request, 'ProjectApp/customers.html', {'customers': customers})


def trans(request):
    trans = transectiondetail.objects.all()
    return render(request, 'ProjectApp/trans.html', {'trans': trans})

def services(request):
    return render(request,'ProjectApp/serv.html')

def fromserv(request):
    return render(request,'ProjectApp/index.html')